...
const sendActivationEmail = (req, res, next) => {
    ...
    const subject = 'Rideshare: Account Activation';
    const content = `Dear ${nickname}, <br/> Please click the following link to activate your account: <br/><a href="${url}">${url}</a><br/><br/>RideShare`;
