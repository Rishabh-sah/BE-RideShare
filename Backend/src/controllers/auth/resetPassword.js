...
const sendResetPasswordLinkToUserByMail = (req, res) => {
    ...
    const subject = 'Rideshare: Reset Password Link';
    const content = `Dear ${nickname}, <br/> Please click the following link to reset your password: <br/><a href="${url}">${url}</a><br/><br/>RideShare`;
